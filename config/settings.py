...
SECRET_KEY = "django-insecure-_b-4&$exc(263$=$o-u7m-3qb$7d9jazm4iah$p4%kvfl7jv5&"
...
# Настройки для отправки приветственного сообщения зарегистрированным пользователям
